...
class IdealPayment extends StatefulWidget {
  const IdealPayment({Key? key}) : super(key: key);

  @override
  _IdealPaymentState createState() => _IdealPaymentState();
}

class _IdealPaymentState extends State<IdealPayment> {
          ...
          child: Column(children: [
            ...
            InkWell(
             ...
             await initPaymentSheet();
              ...
              child: CustomButton(
                  height: 45, width: width(context) * 0.3, text: "Proceed"),
            )
          ]),
        ),
      ),
